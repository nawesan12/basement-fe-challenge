...
export default function CartProduct() {
  return (
    <article className="p-4 border border-white grid grid-cols-6">
      <div className="bg-[linear-gradient(to_top,#111,#000)] p-4 aspect-square col-span-2">
        <Image
      ...
      <div className="col-span-4 font-bold flex flex-col justify-between text-white">
        <div>
          <h4 className="lg:text-3xl text-xl">BLACK T-SHIRT</h4>
        ...
        <div className="grid grid-cols-4 grid-rows-2">
          <div className="col-span-4 row-span-1 text-lg flex items-center gap-2">
            <p>QUANTITY:</p>
            <div className="quantifier border border-white px-2 py-1 rounded-full text-base lg:text-lg font-bold max-w-min flex gap-4">
