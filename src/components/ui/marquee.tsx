  ...
  return (
    <section className="relative max-w-screen p-4 border-t-2 border-b-2 border-white">
      ...
      <Image
        ...
        alt=""
        ref={imageRef1}
        className="absolute z-20 left-20  object-contain size-[12vw] md:size-[11vw] lg:size-[10vw]"
        width={120}
        height={120}
      />
      <Image
        ...
        alt=""
        ref={imageRef2}
        className="absolute z-20 right-24 bottom-0.5 object-contain size-[12vw] md:size-[11vw] lg:size-[10vw]"
        width={120}
        height={120}
      />
    </section>
